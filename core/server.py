...
def start_server(room_code):
    ...
    while room_active[0]:
        try:
            ...
            threading.Thread(target=handle_client, args=(client_socket, room_code, room_active)).start()
        except Exception:
            break
...
def handle_client(client_socket, room_code, room_active):
    ...
    new_client = {client_socket: username}
